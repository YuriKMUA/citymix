...
describe User do
    ...
    before  {  @user = User.new(name: "Foobar", last_name: "Foobary", email: "user@example.com", password: "123456", password_confirmation: "123456", city: "Boston", phone: "+380982125652") }
    subject { @user }
   ...
   describe "found for email and authenticate of user" do
        before { @user1 = User.create(name: "Foobar", last_name: "Foobary", email: "user1@example.com", password: "123456", password_confirmation: "123456", city: "Boston", phone: "+380982125652") }
